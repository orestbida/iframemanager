...
1. #### Download the [latest release](https://github.com/orestbida/iframemanager/releases/latest) or use via CDN:
    ...
    ```bash
    https://cdn.jsdelivr.net/gh/orestbida/iframemanager@1.2.4/dist/iframemanager.js
    https://cdn.jsdelivr.net/gh/orestbida/iframemanager@1.2.4/dist/iframemanager.css
    ```
